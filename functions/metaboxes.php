<?php
function hcc_metaboxes() {
    $prefix = '_hcc_';
    global $hcc_options,$template_parts;
    $blog_id = get_option( 'page_for_posts' );
    if ($_GET['post'] == $blog_id){
        $enabled = ($hcc_options['archive-page-sections']['Enabled']) ? $hcc_options['archive-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($hcc_options['archive-page-sections']['Disabled']) ? $hcc_options['archive-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
    else{
        $enabled = ($hcc_options['general-page-sections']['Enabled']) ? $hcc_options['general-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($hcc_options['general-page-sections']['Disabled']) ? $hcc_options['general-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
...
add_action('cmb2_admin_init', 'hcc_metaboxes');