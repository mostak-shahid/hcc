...
// var_dump($sections);
?><?php get_header() ?>
    <section id="page" class="page-content <?php if(@$hcc_options['sections-content-background-type'] == 1) echo @$hcc_options['sections-content-background'] . ' ';?><?php if(@$hcc_options['sections-content-color-type'] == 1) echo @$hcc_options['sections-content-color'];?>">
