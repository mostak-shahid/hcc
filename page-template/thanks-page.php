...
?>
<section id="page" class="page-content <?php if(@$hcc_options['sections-content-background-type'] == 1) echo @$hcc_options['sections-content-background'] . ' ';?><?php if(@$hcc_options['sections-content-color-type'] == 1) echo @$hcc_options['sections-content-color'];?> <?php echo $class ?>" <?php if(@$background_img) echo 'style="background-image:url('.$background_img.')"'; ?>>
