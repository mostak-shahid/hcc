<?php 
global $hcc_options; 
$class = $hcc_options['sections-widgets-class'];
$title = $hcc_options['sections-widgets-title'];
$content = $hcc_options['sections-widgets-content'];
$widget_layout = $hcc_options['sections-widgets-layout'];
...
?>
<section id="section-widgets" class="<?php if(@$hcc_options['sections-widgets-background-type'] == 1) echo @$hcc_options['sections-widgets-background'] . ' ';?><?php if(@$hcc_options['sections-widgets-color-type'] == 1) echo @$hcc_options['sections-widgets-color'];?> <?php echo $class ?>">
